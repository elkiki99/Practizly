<x-panel-layout title="Configuration • {{ config('app.name', 'Practizly') }}">
    <div class="self-stretch flex-1 space-y-6 max-lg:max-w-2xl max-lg:mx-auto">
        <div>
            <flux:heading level="1" size="lg">Configuration</flux:heading>
            <flux:subheading>Manage your account configuration.</flux:subheading>
        </div>
