...
<ui-select data-editor="heading" class="relative">
    ...
    <ui-options popover="manual" aria-label="{{ __('Styles') }}" class="min-w-[10rem] rounded-lg border border-zinc-200 dark:border-zinc-600 bg-white dark:bg-zinc-700 shadow-2xs p-[5px]">
