...
$classes = Flux::classes()
    ...
    ->add('shadow-2xs [ui-radio[disabled]_&]:opacity-75 [ui-radio[data-checked][disabled]_&]:opacity-50 [ui-radio[disabled]_&]:shadow-none [ui-radio[data-checked]_&]:shadow-none')
    ...
    ->add([
        ...
        '[ui-radio[data-checked]_&]:hover:bg-(--color-accent)',
        '[ui-radio[data-checked]_&]:focus:bg-(--color-accent)',
    ])
    ;
@endphp
