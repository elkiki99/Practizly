...
$classes = Flux::classes()
    ...
    ->add('shadow-2xs [ui-checkbox[disabled]_&]:opacity-75 [ui-checkbox[data-checked][disabled]_&]:opacity-50 [ui-checkbox[disabled]_&]:shadow-none [ui-checkbox[data-checked]_&]:shadow-none [ui-checkbox[data-indeterminate]_&]:shadow-none')
    ...
    ->add([
        ...
        '[ui-checkbox[data-checked]_&]:hover:bg-(--color-accent)',
        '[ui-checkbox[data-checked]_&]:focus:bg-(--color-accent)',
        '[ui-checkbox[data-indeterminate]_&]:bg-[var(--color-accent)]',
        '[ui-checkbox[data-indeterminate]_&]:hover:bg-(--color-accent)',
        '[ui-checkbox[data-indeterminate]_&]:focus:bg-(--color-accent)',
    ])
    ;
@endphp
